...
<p align="center">Tajika helps you create interactive and responsive HTML-based digital business cards that can be hosted with your website.</p>
<h3 align="center"><a href="https://enbizcard.vercel.app">Open App</a> | <a href="https://enbizcard.vercel.app">View demo</a></h3>

---

<p align="center">
<a href="https://www.gnu.org/licenses/agpl-3.0" alt="License: GPLv3"><img src="https://img.shields.io/badge/License-AGPL%20v3-blue"></a> <a href="https://github.com/vishnuraghavb/Tajika/issues" alt="GitHub issues"><img src="https://img.shields.io/github/issues/vishnuraghavb/Tajika?label=Issues"></a> <a href="https://liberapay.com/vishnuraghavb/donate" alt="Liberapay"><img src="https://img.shields.io/liberapay/patrons/vishnuraghavb.svg?logo=liberapay"></a> <a href="https://www.vishnuraghav.com/donate" alt="Donate"><img src="https://img.shields.io/badge/Donate%20to-Vishnu%20Raghav-brightgreen"></a></p>
...
Check out the [roadmap](https://github.com/vishnuraghavb/Tajika/projects/1) to see the upcoming features of Digital Business Card Generator.
...
- [Create an issue here](https://github.com/vishnuraghavb/Tajika/issues)
...
In order to quickly host the Tajika Generator on a machine running Docker and Docker Compose, follow these steps:

1. Clone the repository to your machine and `cd` into the directory.

```
git clone git@github.com:vishnuraghavb/Tajika.git
```
...
```
Tajika - An Open-Source Digital Business Card Generator
